...
def main (title, lc=10, self_weight=False, distribuited_force_x = False, distribuited_force_y = False, Topologic_Optimization = False, def_scale=1, force_scale=1e-2, reaction_scale=1e-2):
    ...
    input_file = "TEST/geo.geo"#"VIGA_DOBLE_T/doble_t.geo"
    output_file ="TEST/msh.msh"# "VIGA_DOBLE_T/doble_t.msh"
    ...
    thickness = {'1':600}#{'1': 115, '2': 120, '3': 120, '4': 120}, tiene que ser con numeros de Plane Surface
    ...
    if distribuited_force_y:
        # Aplicar fuerza distribuida a los nodos
        fuerza_total = 65000*600 #N
        grupo_nodos = grupos['Fuerza 1']
        fuerza_total_y = 3000 #N NO N/m
        apply_distributed_force_y(grupo_nodos, fuerza_total_y, estructure)
        pass
...
if __name__ == "__main__":
    title = 'Prueba' #Debe estar gentro de la carpeta GRAFICOS
    lc = 65
    main(title, lc, self_weight=False, distribuited_force_x = False, distribuited_force_y = True, Topologic_Optimization=False, def_scale=1000, force_scale=1, reaction_scale=5e-3)

    I = (600*600**3)/12
    E = 200000
    L = 2800
    P = 3000
    deformacion = (P*L**3)/(3*E*I)

    print(f"Deformacion teorica: {deformacion:.3f} mm")
